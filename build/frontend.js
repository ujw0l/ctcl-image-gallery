 ...
 */
 ...
 class ctcOverlayViewer {
	...
	constructor(sel, param2) {
		Array.from(document.querySelectorAll(sel)).map((el, i) => this.prepareGal(el, i, param2));
...
/*!*************************!*\
  ...
  \*************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var ctcl_image_gallery_ctcl_image_gallery_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ctcl-image-gallery/ctcl-image-gallery.js */ "./node_modules/ctcl-image-gallery/ctcl-image-gallery.js");
/* harmony import */ var ctc_gallery_viewer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ctc-gallery-viewer */ "./node_modules/ctc-gallery-viewer/ctc_overlay.js");


window.addEventListener('DOMContentLoaded', () => {
  new ctcl_image_gallery_ctcl_image_gallery_js__WEBPACK_IMPORTED_MODULE_0__.ctclImgGal('.ctcl-gallery', {
    ...
    callBack: el => {
      ...
      setTimeout(() => new ctc_gallery_viewer__WEBPACK_IMPORTED_MODULE_1__.ctcOverlayViewer(`#ctcl-gallery-${el.getAttribute('data-clntid')} .ctclig-image-list`), 5000);
    }
  });
});
})();
